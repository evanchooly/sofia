...
open class SofiaMojo : AbstractMojo() {
    ...
    @Parameter(property = "project") lateinit var project: MavenProject
    @Parameter(
        property = "outputDirectory",
        defaultValue = "\${project.build.directory}/generated-sources/sofia"
    )
    lateinit var outputDirectory: File
    @Parameter(defaultValue = "src/main/resources/sofia.properties") lateinit var inputFile: File
    @Parameter(defaultValue = "com.antwerkz.sofia") lateinit var packageName: String
    @Parameter var className: String? = null
    @Parameter(defaultValue = "slf4j") lateinit var loggingType: String
    @Parameter(defaultValue = "java") lateinit var outputType: String
    //    @Parameter(defaultValue = "src/main/webapp/js/sofia.js")
    //    lateinit var jsOutputFile: File
    //    @Parameter(defaultValue = "false")
    //    var javascript: Boolean = false
    @Parameter(defaultValue = "ISO-8859-1") lateinit var charset: String
    ...
    fun generate() {
        ...
        val config =
            SofiaConfig(
                ...
                loadLoggingType(),
                packageName,
                generateJava = this.outputType == "java",
                generateKotlin = this.outputType == "kotlin",
                className = this.className
                        ?: inputFile.nameWithoutExtension.capitalizeFirstLetter(),
